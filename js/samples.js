      ...
      graph: {
        ...
        nodes: [
          ...
          { id: 'w1', type: 'wait', title: '検索結果が出るまで待つ', x: 340, y: 100,
            data: { mode: 'visible', target: t('a#video-title'), timeout: 60 } },
          { id: 'lp', type: 'loop', title: '上から10本くり返す', x: 620, y: 80,
            data: { mode: 'elements', elements_target: t('a#video-title'),
                    limit: 10, continue_on_error: true } },
          { id: 'ck', type: 'click', title: '{{index}}本目の動画を開く', x: 900, y: 60,
            data: { target: { strategy: 'css', selector: 'a#video-title', index: 'loop' },
      ...
      graph: {
        ...
        nodes: [
          ...
          { id: 'w1', type: 'wait', title: '一覧が出るまで待つ', x: 340, y: 100,
            data: { mode: 'visible', target: t('a#video-title, a.yt-lockup-metadata-view-model__title, a.yt-lockup-metadata-view-model-wiz__title'),
                    timeout: 60 } },
          { id: 'lp', type: 'loop', title: '上から10本くり返す', x: 620, y: 80,
            data: { mode: 'elements',
                    elements_target: t('a#video-title, a.yt-lockup-metadata-view-model__title, a.yt-lockup-metadata-view-model-wiz__title'),
                    limit: 10, continue_on_error: true } },
          { id: 'ck', type: 'click', title: '{{index}}本目を開く', x: 900, y: 60,
            data: { target: { strategy: 'css',
                              selector: 'a#video-title, a.yt-lockup-metadata-view-model__title, a.yt-lockup-metadata-view-model-wiz__title',
                              index: 'loop' },
                    wait_after: 'time', wait_ms: 1500 } },
          { id: 'w2', type: 'wait', title: '5秒ながめる', x: 1180, y: 80,
            data: { mode: 'time', ms: 5000 } },
